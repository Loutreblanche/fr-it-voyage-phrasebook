...
const CATEGORIES = [
  ...
  { id: 'famille', group: 'phrases', name: 'Famille & amis', icon: '👨‍👩‍👧', count: 12 },
  { id: 'travail', group: 'phrases', name: 'Travail & études', icon: '💼', count: 12 },
  { id: 'maison', group: 'phrases', name: 'À la maison / location', icon: '🏠', count: 14 },
  { id: 'rendezvous', group: 'phrases', name: 'Rendez-vous & organisation', icon: '⏰', count: 12 },
  { id: 'loisirs', group: 'phrases', name: 'Loisirs & sorties', icon: '🎭', count: 14 },
  { id: 'poste', group: 'phrases', name: 'Poste & services publics', icon: '📮', count: 12 },
  { id: 'enfants', group: 'phrases', name: 'Avec des enfants', icon: '🧒', count: 12 },
  { id: 'opinions', group: 'phrases', name: 'Opinions & sentiments', icon: '💭', count: 12 },
  ...
  { id: 'lex-personnes', group: 'vocab', name: 'Famille & personnes', icon: '👪', count: 20 },
  { id: 'lex-corps', group: 'vocab', name: 'Corps humain', icon: '🖐️', count: 25 },
  { id: 'lex-sante', group: 'vocab', name: 'Santé & pharmacie', icon: '💊', count: 20 },
  { id: 'lex-maison', group: 'vocab', name: 'Maison & mobilier', icon: '🛋️', count: 30 },
  { id: 'lex-cuisine', group: 'vocab', name: 'Cuisine & vaisselle', icon: '🍴', count: 20 },
  { id: 'lex-ville', group: 'vocab', name: 'Ville & bâtiments', icon: '🏛️', count: 25 },
  { id: 'lex-nature', group: 'vocab', name: 'Nature & paysage', icon: '🌳', count: 25 },
  { id: 'lex-animaux', group: 'vocab', name: 'Animaux', icon: '🐕', count: 25 },
  { id: 'lex-metiers', group: 'vocab', name: 'Métiers', icon: '👷', count: 20 },
  { id: 'lex-ecole', group: 'vocab', name: 'École & fournitures', icon: '📚', count: 20 },
  { id: 'lex-numerique', group: 'vocab', name: 'Téléphone & informatique', icon: '💻', count: 20 },
  { id: 'lex-verbes', group: 'vocab', name: 'Verbes courants', icon: '🏃', count: 30 },
  { id: 'lex-adjectifs', group: 'vocab', name: 'Adjectifs courants', icon: '🔤', count: 30 },
];
